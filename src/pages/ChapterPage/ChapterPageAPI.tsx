  ...
  return (
    <div className="min-h-screen bg-bg-primary text-secondary transition-colors duration-300">
      ...
      <main className="container mx-auto px-4 pt-52 md:pt-36 pb-20 max-w-4xl">
        ...
        {/* Interaction Bar */}
        <div className="grid grid-cols-2 md:flex md:items-center md:justify-between gap-y-6 md:gap-0 border-y border-border py-6 mb-12">
            <div className="flex md:contents">
                <div className="flex gap-6 w-full md:w-auto justify-around md:justify-start col-span-2">
                    <button    
                        onClick={handleLike}
            ...
            <button 
                ...
                className="flex items-center justify-center md:justify-start gap-2 text-secondary hover:text-primary transition-colors justify-self-center md:justify-self-auto"
            >
            ...
            <button 
                ...
                className="flex items-center justify-center md:justify-start gap-2 text-secondary hover:text-neon-gold transition-colors md:ml-6 justify-self-center md:justify-self-auto"
            >
                 <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
